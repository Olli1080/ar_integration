...
bool UIpInput::push(int digit, int trip_pos)
{
...
bool UIpInput::pop(int trip_pos)
{
	if (!valid_trip_pos(trip_pos))
		return false;
...
int UIpInput::get_trip_val(int trip_pos) const
{
	if (!valid_trip_pos(trip_pos))
		return -1;
...
FString UIpInput::to_string_trip(int trip_pos) const
{
	if (!valid_trip_pos(trip_pos))
		return "";
...
FString UIpInput::to_string() const
{
	FString temp;
...
bool UIpInput::valid_trip_pos(int trip_pos)
{
