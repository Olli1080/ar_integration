...
void AFrankaTcps::Tick(float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);
}

void AFrankaTcps::BeginDestroy()
{
	Super::BeginDestroy();
}

void AFrankaTcps::set_tcps(const TArray<FVector>& data)
{
...
void AFrankaTcps::clear_Implementation()
{
	instanced->ClearInstances();
}

void AFrankaTcps::set_visibility_Implementation(Visual_Change vis_change)
{
	switch (vis_change)
	{
	case ENABLED:
